...
//include test cases in the build
#define BIOENGINE_TESTING_ON 1
#define BIOENGINE_TESTING_OFF 0

#ifndef BIOENGINE_TESTING_IS_ENABLED
	#ifdef BIOENGINE_TESTING_DISABLED
		#define BIOENGINE_TESTING_IS_ENABLED BIOENGINE_TESTING_OFF
	#else
		#define BIOENGINE_TESTING_IS_ENABLED BIOENGINE_TESTING_ON
	#endif
#endif
